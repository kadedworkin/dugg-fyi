...
Let users forward emails into your Dugg instance using self-describing addresses like `your-server_com+dugg_apikey@dugg.fyi` (dots in the hostname become underscores).
