...
{feed_js}"""
    ...
    def _render_feed_card_html(
        ...
        *,
        ...
        return f"""<div class="card{read_card_class}" id="item-{resource["id"]}" data-collection="{coll_id}" data-source-server="{_xml_escape(source_srv)}" data-url="{_xml_escape(resource['url'])}" data-resource-id="{resource["id"]}" data-read-state="{read_state}" data-source-type="{_xml_escape(source_type or "other")}">
