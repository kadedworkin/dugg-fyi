...
def _handle_invite_user(d: DuggDB, user_id: str, args: dict) -> list[TextContent]:
    ...
    if endpoint:
        ...
        invite_text += (
            ...
            f"\n5. Build your local over time\n"
            f"\n   As you find things worth saving — articles, links, notes —\n"
            f"   add them to your local with dugg_add. When you have something\n"
            f"   worth sharing, publish it:\n"
            f"\n   dugg_publish(resource_id, targets=[\"{instance_name}\"])\n"
            f"\n   No rush. Your local grows at your pace. The more servers\n"
            f"   you subscribe to, the more signal flows to you.\n"
        ...
        invite_text += (
            ...
            f"   Browse, search, react. Build your local over time with\n"
            f"   dugg_add, and publish when you have something worth sharing.\n"
            f"\nPartner guide (read before first submission):\n"
            f"  https://github.com/kadedworkin/dugg-fyi/blob/main/PARTNER_AGENT.md"
        )
