...
def cmd_invite_user(args):
    ...
    if server_url:
        ...
        print()
        print("1. Set up a local Dugg instance")
        print()
        ...
        print("   dugg serve")
        print()
        print("   This is your personal knowledge base. Everything you add")
        print("   lives here first. You choose what to share.")
        print()
        print("2. Redeem this invite on the shared server")
        print()
        ...
        print()
        print("3. Connect to the shared server via MCP")
        print()
        print(f"   SSE endpoint: {server_url.rstrip('/')}/sse")
        print(f"   Auth header: X-Dugg-Key: <agent_api_key from step 2>")
        print()
        print("4. Call dugg_welcome to orient, then dugg_feed to complete onboarding")
        print()
        print("5. Publish from local to shared")
        print()
        print(f'   Use dugg_publish(resource_id, targets=["{instance_name}"])')
        print(f"   to push selected resources from your local instance to the")
        print(f"   shared server. Your local is the source of truth — you control")
        print(f"   what gets shared.")
    else:
        print()
        print("--- For humans ---")
        print()
