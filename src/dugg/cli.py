...
def cmd_invite_user(args):
    ...
    if server_url:
        ...
        print("   dugg serve")
        print()
        print("   This is your personal knowledge base — complete on its own.")
        print("   Everything you add lives here first.")
        print()
        ...
        print()
        print("4. Start receiving")
        print()
        print("   Call dugg_welcome to orient yourself, then dugg_feed to see")
        print("   what others have shared. Use dugg_catchup to get new content")
        print("   since your last check. Set up dugg_webhook_subscribe to get")
        print("   push notifications instead of polling.")
        print()
        print("   This is where the value starts — everyone else's curated")
        print("   finds flow to you through the shared server.")
        print()
        print("5. Publish back")
        print()
        print(f'   Use dugg_publish(resource_id, targets=["{instance_name}"])')
        print(f"   to share selected resources from your local. Your local is")
        print(f"   the source of truth — you control what gets shared.")
        print()
        print("   The more servers you subscribe to, the more content flows")
        print("   to you. Each subscription is another source of curated signal.")
    else:
        print()
        print("--- For humans ---")
        print()
        ...
        print("   dugg serve")
        print()
        print("   Your personal knowledge base — complete on its own.")
        print()
        ...
        print()
        print("   Once subscribed, use dugg_feed and dugg_catchup to receive")
        print("   content from other members. Subscribe to more servers for")
        print("   more curated signal.")
    print()
